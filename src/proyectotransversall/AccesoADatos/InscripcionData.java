...
import proyectotransversall.Entidades.Alumno;
import proyectotransversall.Entidades.Inscripcion;
...
public class InscripcionData {
    ...
    public List<Materia> obtenermateriasNoCursadas(int idAlumno){
        ...
        String sql = "SELECT * FROM materia WHERE estado = 1 AND idMateria not in"
                + "(SELECT idMateria FROM inscripcion WHERE id Alumno = ?)";
    ...
    public List<Alumno> obtenerAlumnosXMateria(int idMateria){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al intentar acceder a las tablas");
        }
